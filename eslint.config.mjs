...
export default defineConfig(
	...
	// TypeScript 本地覆写规则。
	{
		name: "fast-utils/typescript/type-checked",
		files: ["**/*.{ts,cts,mts,tsx}"],
		extends: [
			eslintJs.configs.recommended,
			{
				name: "fast-utils/typescript/javascript-rules",
				/**
				 * JavaScript 本地覆写规则。
				 *
				 * @remarks
